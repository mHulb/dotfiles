...
defaults write com.knollsoft.Rectangle screenEdgeGapBottom -int 40
defaults write com.knollsoft.Rectangle screenEdgeGapLeft -int 40
defaults write com.knollsoft.Rectangle screenEdgeGapRight -int 40
